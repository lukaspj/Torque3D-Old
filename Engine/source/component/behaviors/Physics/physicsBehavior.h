...
/// 
//////////////////////////////////////////////////////////////////////////
class PhysicsBehavior : public BehaviorTemplate
{
...
public:
   ...
   DECLARE_CONOBJECT(PhysicsBehavior);

   //override to pass back a StaticPhysicsBehaviorInstance
   virtual BehaviorInstance *createInstance();
};

class PhysicsBehaviorInstance : public BehaviorInstance
{
...
public:
   ...
   PhysicsBehaviorInstance(BehaviorTemplate *btemplate = NULL);
   virtual ~PhysicsBehaviorInstance();
   DECLARE_CONOBJECT(PhysicsBehaviorInstance);
