...
bool LightBaseBehaviorInstance::smRenderViz = false;
...
IMPLEMENT_CO_NETOBJECT_V1(LightBaseBehavior);

//////////////////////////////////////////////////////////////////////////
BehaviorInstance *LightBaseBehavior::createInstance()
{
   LightBaseBehaviorInstance *instance = new LightBaseBehaviorInstance(this);
...
void LightBaseBehavior::onRemove()
{
   Parent::onRemove();
}
void LightBaseBehavior::initPersistFields()
{
...
//==========================================================================================
//==========================================================================================
LightBaseBehaviorInstance::LightBaseBehaviorInstance( BehaviorTemplate *btemplate ) 
{
   mTemplate = btemplate;
   mBehaviorOwner = NULL;
...
bool LightBaseBehaviorInstance::onAdd()
{
   if(! Parent::onAdd())
      return false;
...
void LightBaseBehaviorInstance::onRemove()
{
   Parent::onRemove();
}
...
void LightBaseBehaviorInstance::onBehaviorAdd()
{
   Parent::onBehaviorAdd();
}

void LightBaseBehaviorInstance::onBehaviorRemove()
{
...
void LightBaseBehaviorInstance::submitLights( LightManager *lm, bool staticLighting )
{
...
void LightBaseBehaviorInstance::prepRenderImage( SceneRenderState *state )
{
   if ( mIsEnabled && mFlareData )
   {
      ...
      mFlareState.lightMat = mBehaviorOwner->getRenderTransform();
   ...
   if ( smRenderViz || isSelectedInEditor )
   {
      ...
      ri->renderDelegate.bind( this, &LightBaseBehaviorInstance::_onRenderViz );
...
U32 LightBaseBehaviorInstance::packUpdate( NetConnection *conn, U32 mask, BitStream *stream )
{
...
void LightBaseBehaviorInstance::unpackUpdate( NetConnection *conn, BitStream *stream )
{
...
void LightBaseBehaviorInstance::setLightEnabled( bool enabled )
{
